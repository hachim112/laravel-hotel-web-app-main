...
<div class="facility-form-container">
        ...
        <div class="header-content">
            <div class="header-title-section">
                ...
                <div class="header-text">
                    <h1 class="page-title">Edit Fasilitas Hotel</h1>
                    <p class="page-subtitle">Perbarui informasi fasilitas hotel</p>
                </div>
            </div>
    ...
    <div class="form-card-modern">
        <div class="form-body">
            <form action="{{ route('hotelfacility.update', $data->id) }}" method="post" class="facility-form">
                @csrf
                @method('patch')
                ...
                <div class="form-group-modern">
                    ...
                    <div class="textarea-wrapper">
                        <textarea name="detail" 
                                  ...
                                  required 
                                  autocomplete="detail" 
                                  placeholder="Masukkan deskripsi detail fasilitas">{{ old('detail') }}{{ $data->detail }}</textarea>
