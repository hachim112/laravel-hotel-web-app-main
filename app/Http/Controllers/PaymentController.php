...
class PaymentController extends Controller
{
    ...
    public function receptionisPayments()
    {
        // Get all payments with proof uploaded, but not yet confirmed/rejected
        $payments = Payment::whereNotNull('bukti')->where('status', 'pending')->get();
        return view('receptionis.payments', compact('payments'));
    }
    ...
    public function confirmPayment($id)
    {
        ...
        // Optionally, update the related transaction status
    ...
    public function rejectPayment($id)
    {
        ...
        // Optionally, update the related transaction status
        $payment->transaction->status = 'payment rejected';
        $payment->transaction->save();
